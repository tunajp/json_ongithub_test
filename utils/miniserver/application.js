...
System.register("../utils/miniserver/app", [], function() {
  "use strict";
  var __moduleName = "../utils/miniserver/app";
  var Application = function Application() {
    this.http_ = require('http');
    this.connect_ = require('connect');
  };
  ($traceurRuntime.createClass)(Application, {run: function() {
      var con = this.connect_().use(this.connect_.static('./')).use(this.connect_.logger('dev'));
...
System.get("../utils/miniserver/app" + '');
